...
glm::vec3 MovementSystem::Move(float _deltaTime,float _rotation, glm::vec3 _position, glm::vec3 _direction)
{
	glm::mat4 model(1.0f);
...
{
	return Move(_deltaTime,  _rotation, _position, glm::vec3(0, 0, -1));
}
...
{
	return Move(_deltaTime, _rotation, _position, glm::vec3(-1, 0, 0));
}
